...
🛑 *.stop* ➔ Réinitialiser le jeu actif`;
      ...
      if (lowerText.startsWith('.iagmini')) {
        ...
        // 🔑 COLLE TA CLÉ API GEMINI DANS LA VARIABLE CI-DESSOUS
        const API_KEY = "COLLE_TA_CLE_API_ICI";

        if (API_KEY === "COLLE_TA_CLE_API_ICI") {
          await envoyerAvecDelai(sock, remoteJid, { text: "⚠️ Clé API non configurée ! Remplace `COLLE_TA_CLE_API_ICI` dans index.js par ta vraie clé API." }, { quoted: msg }, msg);
          return;
        }
      ...
      // 💖 FONCTION LOVE (SOLO, 1 MENTION, 2 MENTIONS)
